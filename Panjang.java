...
public class Panjang extends JFrame{
	...
	private void Initialize(){
		...
		jTable = new JTable();
		jBtnPerpanjang = new JButton();
		jBtnKembali = new JButton();
		jLblKode = new JLabel();
		jLblHari = new JLabel();
		jTFKode = new JTextField();
		jTFHari = new JTextField();
		jLblAku = new JLabel();
		jPanel = new JPanel();
		...
		jLblHari.setText("Durasi hari");
		jLblAku.setText("Misael Trifosa - 1805100");	// Ceritanya footer		
		
		// Setting untuk button pengembalian
		jBtnPerpanjang.setText("Perpanjang");
		jBtnPerpanjang.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent evt){
				jBtnPerpanjangActionPerformed(evt);
			}
		});
				...
				.addGroup(jPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
					.addGroup(jPanelLayout.createSequentialGroup()
						.addGroup(jPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
							...
							.addComponent(jLblHari))
							
						.addGap(18, 18, 18)
						
						.addGroup(jPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
							.addComponent(jTFKode)
							.addComponent(jTFHari)
							.addComponent(jBtnPerpanjang, GroupLayout.PREFERRED_SIZE, 120, GroupLayout.PREFERRED_SIZE))
		...
		jPanelLayout.setVerticalGroup(
			...
			.addGroup(jPanelLayout.createSequentialGroup()
				...
				.addGroup(jPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
					.addComponent(jLblHari)
					.addComponent(jTFHari, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
					
				.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
				
				.addGroup(jPanelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
					.addComponent(jBtnPerpanjang)
	...
	private void jBtnPerpanjangActionPerformed(java.awt.event.ActionEvent evt){
		clearField();
	}
	
	private void jBtnKembaliActionPerformed(java.awt.event.ActionEvent evt){
		Panjang.this.dispose();			// Untuk menutup form panjang
		Awal baru = new Awal();			// Untuk memanggil form awal
		baru.jBtnPanjang.setVisible(false);	// Menyembunyikan button
		baru.setVisible(true);
		//baru.jBtnPanjang.setEnabled(false);	// Untuk membuat button tidak bisa diklik
	}
	...
	private JButton jBtnPerpanjang;
	private JButton jBtnKembali;
	private JLabel jLblKode;
	private JLabel jLblHari;
	private JTextField jTFKode;
	private JTextField jTFHari;
